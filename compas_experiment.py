...
# print(f'MAX and MIN foil1: {max(X[foil_feature1])} {min(X[foil_feature1])}')
# print(f'MAX and MIN foil1: {max(X[foil_feature2])} {min(X[foil_feature2])}')
...
X = X.values
# print(f'MAX and MIN foil1: {max(X[:, unrelated_indcs])} {min(X[:, unrelated_indcs])}')
# print(f'MAX and MIN foil1: {max(X[:, unrelated_indcs1])} {min(X[:, unrelated_indcs1])}')
...
def experiment_main(verbose=False):
	...
	* We print out the rate at which features occur in the top three features
	...
	if verbose:
		...
		print(f'\t %compas LIME-1 fidelity {adv_lime.fidelity(xtest)}')
	...
	if verbose:
		...
		print(f' compas1 & lime & PGI & {np.mean(sens_lime_pgi):.3f} & {np.mean(foil_lime1_pgi):.3f} & {np.mean(foil_lime2_pgi):.3f} & {np.mean([score for _, score in pgi_results]):.3f} \\\\ ')
		print(f' compas1 & lime & PGU & {np.mean(sens_lime_pgu):.3f} & {np.mean(foil_lime1_pgu):.3f} & {np.mean(foil_lime2_pgu):.3f} & {np.mean([score for _, score in pgu_results]):.3f} \\\\ ')
		print(f' compas1 & lime & AXE & {np.mean(sens_lime_bex):.3f} & {np.mean(foil_lime1_bex):.3f} & {np.mean(foil_lime2_bex):.3f} & {np.mean([score for _, score in bex_results]):.3f} \\\\ ')
	...
	if verbose:
		...
		print(f'\t %compas LIME-2 fidelity {adv_lime.fidelity(xtest)}')
	...
	if verbose:
		...
		print(f' compas2 & lime & PGI & {np.mean(sens_lime_pgi):.3f} & {np.mean(foil_lime1_pgi):.3f} & {np.mean(foil_lime2_pgi):.3f} & {np.mean([score for _, score in pgi_results]):.3f} \\\\ ')
		print(f' compas2 & lime & PGU & {np.mean(sens_lime_pgu):.3f} & {np.mean(foil_lime1_pgu):.3f} & {np.mean(foil_lime2_pgu):.3f} & {np.mean([score for _, score in pgu_results]):.3f} \\\\ ')
		print(f' compas2 & lime & AXE & {np.mean(sens_lime_bex):.3f} & {np.mean(foil_lime1_bex):.3f} & {np.mean(foil_lime2_bex):.3f} & {np.mean([score for _, score in bex_results]):.3f} \\\\ ')
	...
	if verbose:
		...
		print(f'\t %compas SHAP-1 fidelity {adv_shap.fidelity(xtest)}')
	...
	if verbose:
		...
		print(f' compas1 & shap & PGI & {np.mean(sens_shap_pgi):.3f} & {np.mean(foil_shap1_pgi):.3f} & {np.mean(foil_shap2_pgi):.3f} & {np.mean([score for _, score in pgi_results]):.3f} \\\\ ')
		print(f' compas1 & shap & PGU & {np.mean(sens_shap_pgu):.3f} & {np.mean(foil_shap1_pgu):.3f} & {np.mean(foil_shap2_pgu):.3f} & {np.mean([score for _, score in pgu_results]):.3f} \\\\ ')
		print(f' compas1 & shap & AXE & {np.mean(sens_shap_bex):.3f} & {np.mean(foil_shap1_bex):.3f} & {np.mean(foil_shap2_bex):.3f} & {np.mean([score for _, score in bex_results]):.3f} \\\\ ')
	...
	if verbose:
		...
		print(f'\t %compas SHAP-2 fidelity {adv_shap.fidelity(xtest)}')
	...
	if verbose:
		...
		print(f' compas2 & shap & PGI & {np.mean(sens_shap_pgi):.3f} & {np.mean(foil_shap1_pgi):.3f} & {np.mean(foil_shap2_pgi):.3f} & {np.mean([score for _, score in pgi_results]):.3f} \\\\ ')
		print(f' compas2 & shap & PGU & {np.mean(sens_shap_pgu):.3f} & {np.mean(foil_shap1_pgu):.3f} & {np.mean(foil_shap2_pgu):.3f} & {np.mean([score for _, score in pgu_results]):.3f} \\\\ ')
		print(f' compas2 & shap & AXE & {np.mean(sens_shap_bex):.3f} & {np.mean(foil_shap1_bex):.3f} & {np.mean(foil_shap2_bex):.3f} & {np.mean([score for _, score in bex_results]):.3f} \\\\ ')
	...
	# print(f'(H) FOIL Mean {foil_feature1} PGI for adv_lime model: {np.mean(foil_lime21_pgi)}')
